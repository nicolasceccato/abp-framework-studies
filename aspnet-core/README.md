...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 16f21bd6-8fe5-4f5c-aa7f-2bd895b53490
```

> `16f21bd6-8fe5-4f5c-aa7f-2bd895b53490` is the password of the certificate, you can change it to any password you want.
